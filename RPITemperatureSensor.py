...
def read_cpuTemp():
	...
	#this statement return full line which include Temp=42.9
	temp = temp[5:9]
	print (temp) 
	return temp
...
i = 0
#send data only 10 time. This still need some error handling. 
while i < 10:

	temp = read_cpuTemp()
	message = {'Temp': temp, "device_id":"RPI1","Location":"Bangalore"}
